...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "./common.js"
  ...
  export interface SkillChainInterface extends Interface {
...
encodeFunctionData(functionFragment: 'issueCertification', values: [AddressLike, string, string, string, BigNumberish, BigNumberish, string]): string;
...
decodeFunctionResult(functionFragment: 'issueCertification', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
    ...
    export namespace CertificationIssuedEvent {
      export type InputTuple = [tokenId: BigNumberish, student: AddressLike, issuer: AddressLike];
  ...
  export interface SkillChain extends BaseContract {
    
    connect(runner?: ContractRunner | null): SkillChain;
    waitForDeployment(): Promise<this>;

    interface: SkillChainInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    issueCertification: TypedContractMethod<
      [student: AddressLike, tokenURI_: string, name: string, resourceType: string, status: BigNumberish, grade: BigNumberish, ipfsHash: string, ],
      [bigint],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'isApprovedForAll'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'issueCertification'): TypedContractMethod<
      [student: AddressLike, tokenURI_: string, name: string, resourceType: string, status: BigNumberish, grade: BigNumberish, ipfsHash: string, ],
      [bigint],
      'nonpayable'
    >;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'CertificationIssued(uint256,address,address)': TypedContractEvent<CertificationIssuedEvent.InputTuple, CertificationIssuedEvent.OutputTuple, CertificationIssuedEvent.OutputObject>;
      CertificationIssued: TypedContractEvent<CertificationIssuedEvent.InputTuple, CertificationIssuedEvent.OutputTuple, CertificationIssuedEvent.OutputObject>;
